...
#include <QPainter>
#include <QPixmap>
MyShadow::MyShadow(QObject *parent):QGraphicsEffect(parent),_distance(4.0f),_blurRadius(10.0f),_color(0,0,0,80)
{
...
void MyShadow::draw(QPainter* painter)
{
...
QRectF MyShadow::boundingRectFor(const QRectF& rect) const
{
